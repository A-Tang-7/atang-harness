...
Before logging anything, ensure the `./.learnings/` directory and files exist in the this skill directory (same level as SKILL.md). If any are missing, create them:
...
For Claude Code, Codex, Copilot, or other agents, create `./.learnings/` in the this skill directory (same level as SKILL.md):
